 ...
 */
package org.orbisgis.toc.se.icons;
...
/**
 * Icon manager for SE advanced style editor
 * @author Erwan Bocher
 */
public class SEAdvancedIcon {
    
    private static BaseIcon iconManager = new BaseIcon(LoggerFactory.getLogger(SEAdvancedIcon.class));

    /**
     * This is a static class
     */
    private SEAdvancedIcon() {
    }
    ...
    public static Image getIconImage(String iconName) {
        return iconManager.getIconImage(SEAdvancedIcon.class, iconName);
    }
    /**
    ...
    public static ImageIcon getIcon(String iconName) {
        return iconManager.getIcon(SEAdvancedIcon.class, iconName);
    }
